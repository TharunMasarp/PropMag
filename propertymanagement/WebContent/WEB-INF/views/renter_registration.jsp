		...
		<form:form action="renter_reg.htm" method="post" modelAttribute="renterReg">
			<table align="center">
				<tr>
					...
					<td><font color="red"><form:error path="firstName"></form:error></font></td>
				</tr>
				<tr>
					<td>Last Name</td>
					<td><input path="lastName"></td>
					<td><font color="red"><form:error path="lastName"></form:error></font></td>
				</tr>
				<tr>
					<td>Location</td>
					<td><input path="location"></td>
					<td><font color="red"><form:error path="location"></form:error></font></td>
				</tr>
				<tr>
					<td>Mobile No</td>
					<td><input path="mobile"></td>
					<td><font color="red"><form:error path="mobile"></form:error></font></td>
				</tr>
				<tr>
					<td>Email</td>
					<td><input path="email"></td>
					<td><font color="red"><form:error path="email"></form:error></font></td>
				</tr>
				<tr>
					<td>Password</td>
					<td><input path="password"></td>
					<td><font color="red"><form:error path="password"></form:error></font></td>
				</tr>
				<tr>
					<td>Confirm Password</td>
					<td><input path="cpassword"></td>
					<td><font color="red"><form:error path="cpassword"></form:error></font></td>
				</tr>
				<tr>
