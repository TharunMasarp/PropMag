...
<html>
	...
	<body>
		...
		<form:form action="add_req.htm" method="post" modelAttribute="addReq">
			<table align="center">
				<tr>
					<td>Property Type</td>
					<td><input path="propType"/></td>
					<td><font color="red"><form:errors path="propType"></form:errors></font></td>
				</tr>
				<tr>
					<td>Location</td>
